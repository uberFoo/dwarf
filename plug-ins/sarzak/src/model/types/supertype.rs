...
impl Supertype {
    ...
    pub fn new(obj_id: &Rc<RefCell<Object>>, store: &mut SarzakRcStore) -> Rc<RefCell<Supertype>> {
        let id = Uuid::new_v4();
    ...
    pub fn r14_object<'a>(&'a self, store: &'a SarzakRcStore) -> Vec<Rc<RefCell<Object>>> {
        span!("r14_object");
    ...
    pub fn r13_isa<'a>(&'a self, store: &'a SarzakRcStore) -> Vec<Rc<RefCell<Isa>>> {
        span!("r13_isa");
        vec![store
            .iter_isa()
