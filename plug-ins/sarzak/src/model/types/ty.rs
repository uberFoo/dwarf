...
use crate::v2::sarzak_rc::types::attribute::Attribute;
use crate::v2::sarzak_rc::types::boolean::BOOLEAN;
use crate::v2::sarzak_rc::types::external::External;
use crate::v2::sarzak_rc::types::float::FLOAT;
use crate::v2::sarzak_rc::types::integer::INTEGER;
use crate::v2::sarzak_rc::types::object::Object;
use crate::v2::sarzak_rc::types::s_string::S_STRING;
use crate::v2::sarzak_rc::types::s_uuid::S_UUID;
...
impl Ty {
    ...
    pub fn new_boolean(store: &SarzakRcStore) -> Rc<RefCell<Self>> {
    ...
    pub fn new_float(store: &SarzakRcStore) -> Rc<RefCell<Self>> {
        // This is already in the store.
        store.exhume_ty(&FLOAT).unwrap()
    }

    /// Create a new instance of Ty::Integer
    pub fn new_integer(store: &SarzakRcStore) -> Rc<RefCell<Self>> {
        // This is already in the store.
    ...
    pub fn new_s_string(store: &SarzakRcStore) -> Rc<RefCell<Self>> {
        // This is already in the store.
        store.exhume_ty(&S_STRING).unwrap()
    }

    /// Create a new instance of Ty::SUuid
    pub fn new_s_uuid(store: &SarzakRcStore) -> Rc<RefCell<Self>> {
        // This is already in the store.
    ...
    pub fn r2_attribute<'a>(&'a self, store: &'a SarzakRcStore) -> Vec<Rc<RefCell<Attribute>>> {
        span!("r2_attribute");
        vec![store
            .iter_attribute()
