...
impl Object {
    ...
    pub fn r1_attribute<'a>(&'a self, store: &'a SarzakRcStore) -> Vec<Rc<RefCell<Attribute>>> {
        span!("r1_attribute");
        store
            .iter_attribute()
    ...
    pub fn r19_event<'a>(&'a self, store: &'a SarzakRcStore) -> Vec<Rc<RefCell<Event>>> {
        span!("r19_event");
        store
            .iter_event()
    ...
    pub fn r16_referent<'a>(&'a self, store: &'a SarzakRcStore) -> Vec<Rc<RefCell<Referent>>> {
        span!("r16_referent");
        store
            .iter_referent()
    ...
    pub fn r17_referrer<'a>(&'a self, store: &'a SarzakRcStore) -> Vec<Rc<RefCell<Referrer>>> {
        span!("r17_referrer");
        store
            .iter_referrer()
    ...
    pub fn r18_state<'a>(&'a self, store: &'a SarzakRcStore) -> Vec<Rc<RefCell<State>>> {
        span!("r18_state");
        store
            .iter_state()
    ...
    pub fn r15_subtype<'a>(&'a self, store: &'a SarzakRcStore) -> Vec<Rc<RefCell<Subtype>>> {
        span!("r15_subtype");
        store
            .iter_subtype()
    ...
    pub fn r14_supertype<'a>(&'a self, store: &'a SarzakRcStore) -> Vec<Rc<RefCell<Supertype>>> {
        span!("r14_supertype");
        store
            .iter_supertype()
