...
impl Referent {
    ...
    pub fn r8_cardinality<'a>(&'a self, store: &'a SarzakRcStore) -> Vec<Rc<RefCell<Cardinality>>> {
        span!("r8_cardinality");
    ...
    pub fn r16_object<'a>(&'a self, store: &'a SarzakRcStore) -> Vec<Rc<RefCell<Object>>> {
        span!("r16_object");
    ...
    pub fn r5_binary<'a>(&'a self, store: &'a SarzakRcStore) -> Vec<Rc<RefCell<Binary>>> {
        span!("r5_binary");
        vec![store
            .iter_binary()
