//! v2::sarzak_rc Object Store
//!
//! The ObjectStore contains instances of objects in the domain.
//! The instances are stored in a hash map, keyed by the object's UUID.
//! This is used during code generation, and probably not useful elsewhere.
// {"magic":"","directive":{"Start":{"directive":"ignore-orig","tag":"v2::sarzak_rc-object-store-file"}}}
//!
//! # Contents:
//!
//! * [`AcknowledgedEvent`]
...
//! * [`Supertype`]
//! * [`Ty`]
// {"magic":"","directive":{"Start":{"directive":"ignore-orig","tag":"v2::sarzak_rc-object-store-definition"}}}
...
impl ObjectStore {
    ...
    // {"magic":"","directive":{"Start":{"directive":"ignore-orig","tag":"v2::sarzak_rc-object-store-methods"}}}
    ...
    // {"magic":"","directive":{"Start":{"directive":"ignore-orig","tag":"v2::sarzak_rc-object-store-persistence"}}}
    /// Persist the store.
    ///
